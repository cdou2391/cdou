...
namespace Music_Player.Database1DataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `Field1` IS NULL) OR (`Fie" +
                "ld1` = ?)) AND ((? = 1 AND `Field2` IS NULL) OR (`Field2` = ?)) AND ((? = 1 AND " +
                "`Field3` IS NULL) OR (`Field3` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `Field1` = ?, `Field2` = ?, `Field3` = ? WHERE ((`ID` = ?) AN" +
                "D ((? = 1 AND `Field1` IS NULL) OR (`Field1` = ?)) AND ((? = 1 AND `Field2` IS N" +
                "ULL) OR (`Field2` = ?)) AND ((? = 1 AND `Field3` IS NULL) OR (`Field3` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Music_Player.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Field1, Field2, Field3 FROM Table1";
