...
namespace Music_Player.ChatLyrics {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.chartlyrics.com/", ConfigurationName="ChatLyrics.apiv1Soap")]
    public interface apiv1Soap {
        ...
        Music_Player.ChatLyrics.SearchLyricResult[] SearchLyric(string artist, string song);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.chartlyrics.com/SearchLyric", ReplyAction="*")]
        System.Threading.Tasks.Task<Music_Player.ChatLyrics.SearchLyricResult[]> SearchLyricAsync(string artist, string song);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.chartlyrics.com/SearchLyricText", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Music_Player.ChatLyrics.SearchLyricResult[] SearchLyricText(string lyricText);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.chartlyrics.com/SearchLyricText", ReplyAction="*")]
        System.Threading.Tasks.Task<Music_Player.ChatLyrics.SearchLyricResult[]> SearchLyricTextAsync(string lyricText);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.chartlyrics.com/GetLyric", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Music_Player.ChatLyrics.GetLyricResult GetLyric(int lyricId, string lyricCheckSum);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.chartlyrics.com/GetLyric", ReplyAction="*")]
        System.Threading.Tasks.Task<Music_Player.ChatLyrics.GetLyricResult> GetLyricAsync(int lyricId, string lyricCheckSum);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Music_Player.ChatLyrics.GetLyricResult SearchLyricDirect(string artist, string song);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.chartlyrics.com/SearchLyricDirect", ReplyAction="*")]
        System.Threading.Tasks.Task<Music_Player.ChatLyrics.GetLyricResult> SearchLyricDirectAsync(string artist, string song);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface apiv1SoapChannel : Music_Player.ChatLyrics.apiv1Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class apiv1SoapClient : System.ServiceModel.ClientBase<Music_Player.ChatLyrics.apiv1Soap>, Music_Player.ChatLyrics.apiv1Soap {
        ...
        public Music_Player.ChatLyrics.SearchLyricResult[] SearchLyric(string artist, string song) {
            return base.Channel.SearchLyric(artist, song);
        }
        
        public System.Threading.Tasks.Task<Music_Player.ChatLyrics.SearchLyricResult[]> SearchLyricAsync(string artist, string song) {
            return base.Channel.SearchLyricAsync(artist, song);
        }
        
        public Music_Player.ChatLyrics.SearchLyricResult[] SearchLyricText(string lyricText) {
            return base.Channel.SearchLyricText(lyricText);
        }
        
        public System.Threading.Tasks.Task<Music_Player.ChatLyrics.SearchLyricResult[]> SearchLyricTextAsync(string lyricText) {
            return base.Channel.SearchLyricTextAsync(lyricText);
        }
        
        public Music_Player.ChatLyrics.GetLyricResult GetLyric(int lyricId, string lyricCheckSum) {
            return base.Channel.GetLyric(lyricId, lyricCheckSum);
        }
        
        public System.Threading.Tasks.Task<Music_Player.ChatLyrics.GetLyricResult> GetLyricAsync(int lyricId, string lyricCheckSum) {
        ...
        public Music_Player.ChatLyrics.GetLyricResult SearchLyricDirect(string artist, string song) {
            return base.Channel.SearchLyricDirect(artist, song);
        }
        
        public System.Threading.Tasks.Task<Music_Player.ChatLyrics.GetLyricResult> SearchLyricDirectAsync(string artist, string song) {
